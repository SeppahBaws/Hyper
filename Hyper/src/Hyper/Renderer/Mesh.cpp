...
namespace Hyper
{
	Mesh::Mesh(RenderContext* pRenderCtx, const std::vector<VertexPosNormTex>& vertices, const std::vector<u32>& indices)
		: m_pRenderCtx(pRenderCtx), m_Vertices(vertices), m_Indices(indices)
	{
		// Vertex buffer
