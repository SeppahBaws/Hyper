...
static void ImGui_ImplVulkan_CreatePipeline(VkDevice device, const VkAllocationCallbacks* allocator, VkPipelineCache pipelineCache, VkRenderPass renderPass, VkSampleCountFlagBits MSAASamples, VkPipeline* pipeline, uint32_t subpass)
{
    ...
    pipelineRenderingCreateInfo.stencilAttachmentFormat = bd->VulkanInitInfo.DepthAttachmentFormat;
...
static void ImGui_ImplVulkan_RenderWindow(ImGuiViewport* viewport, void*)
{
    ...
    ImGui_ImplVulkanH_FrameSemaphores* fsd = &wd->FrameSemaphores[wd->SemaphoreIndex];
    {
        ...
        if (bd->VulkanInitInfo.UseDynamicRendering)
        {
            ...
            imageBarrier.image = fd->Backbuffer;
            ...
            colorAttachment.clearValue = (viewport->Flags & ImGuiViewportFlags_NoRendererClear) ? VkClearValue() : wd->ClearValue;
